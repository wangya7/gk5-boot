...
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        String typeAliasesPackage = setTypeAliasesPackage(mybatisProperties.getTypeAliasesPackage());
        VFS.addImplClass(SpringBootVFS.class);

        SqlSessionFactoryBean sessionFactory = new SqlSessionFactoryBean();
        sessionFactory.setDataSource(dataSource);
        sessionFactory.setTypeAliasesPackage(typeAliasesPackage);
        sessionFactory.setMapperLocations(resolveMapperLocations(mybatisProperties.getMapperLocations()));
        sessionFactory.setConfigLocation(new DefaultResourceLoader().getResource(mybatisProperties.getConfigLocation()));
        sessionFactory.getObject().getConfiguration().addInterceptor(new PerformanceInterceptor());
